...
class ManaHelperTest {
    ...
    fun testManaSingleCost() {
        assertEquals("<i class=\"ms ms-1 ms-cost\"></i>", manaHelper.mana("{1}"))
    }

    @Test
    fun testManaWithSize() {
        assertEquals("<i class=\"ms ms-1 ms-cost ms-2x\"></i>", manaHelper.mana2x("{1}"))
    }
    ...
    @Test
    fun testManaHybrid() {
        assertEquals("<i class=\"ms ms-ub ms-split ms-cost ms-2x\"></i>", manaHelper.mana2x("{U/B}"))
    }

    @Test
    fun testManaPhyrexian() {
        assertEquals("<i class=\"ms ms-up ms-cost ms-2x\"></i>", manaHelper.mana2x("{U/P}"))
    }
    
    @Test
    fun testManaColorless() {
        assertEquals("<i class=\"ms ms-c ms-cost ms-2x\"></i>", manaHelper.mana2x("{C}"))
    }
}